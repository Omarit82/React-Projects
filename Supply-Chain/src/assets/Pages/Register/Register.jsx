        ...
        <main>
            <div className="container">
                ...
                <form action="" onSubmit={handleSubmit(onSubmit)} className="d-flex flex-column w-50 m-auto">
                    ...
                    <label htmlFor="nombre" className="text-center campo mb-1 w-50 m-auto">Nombre</label>
                    ...
                    <label htmlFor="apellido" className="text-center campo mb-1 w-50 m-auto">Apellido</label>
                    ...
                    <label htmlFor="email" className="text-center campo mb-1 w-50 m-auto">Email</label>
                    <input type="email" name="email" placeholder="...Email " {...register('email',{required:true})} className="text-center mb-1 m-auto w-50"/>
                    {errors.user && <span className="text-center mb-1 ">Campo Requerido</span>}

                    <label htmlFor="password" className="text-center campo mb-1 w-50 m-auto">Password</label>
                    ...
                    <label htmlFor="passwordCheck" className="text-center campo mb-1 w-50 m-auto">Repertir password</label>
                    ...
                    <label htmlFor="image" className="text-center campo mb-1 w-50 m-auto">Avatar</label>
                    <input type="file" accept="image/*" name="image"  {...register('image')}className="mb-3 w-75 m-auto" />
